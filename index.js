...
function changeLHS() {
  ...
  let userInp = document.getElementById("inp-num").value;

  var elements = document.getElementsByClassName("inp-num-el");
...
function unitConverter() {
  ...
  let userInput = document.getElementById("inp-num").value;
